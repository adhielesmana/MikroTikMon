...
- **Deployment Script**: `intelligent-deploy.sh` with smart behavior:
  ...
  - **Auto-creates directories**: `attached_assets/logos/`, `logs/`, `backups/` with proper ownership (UID 1001 - nodejs user)
